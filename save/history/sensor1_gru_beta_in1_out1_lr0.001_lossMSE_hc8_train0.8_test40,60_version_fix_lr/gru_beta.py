...
learnable_variable = nn.Parameter(torch.Tensor(1))
class GRU(nn.Module):
    def __init__(self, in_dim, out_dim, timestep_in, timestep_out, num_layers, hidden_layer, device):
        ...
        self.weight = learnable_variable
        self.in_dim = in_dim
...
#         print('x shape is ', x.shape)
        ...
        self.weight.data = torch.clamp(self.weight.data, 0, 10)
        out = out - (self.weight * x_r) #   here constant is a   hyperparameters      xr is beta       #new ver 10  old ver 5  sensor1 = 10  sensor2 =7.5  sensor3 = 2.2 sensor4 = 2.5
